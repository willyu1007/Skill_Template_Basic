...
## Purpose
Standardize the **"landing" (落盘适配)** process for Agent Skills so a skills bundle can be applied to **any repository** and consumed by **any LLM/agent runtime** that implements the folder-based `SKILL.md` convention.
