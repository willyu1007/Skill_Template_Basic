...
Run the Stage A checklist after drafting all Stage A docs, **before** requesting user approval.
...
Run the Stage B checklist after drafting `project-blueprint.json`, **before** requesting user approval.
...
Run the Stage C checklist after `apply` command, **before** cleanup.
...
- Stage A: `check-docs --strict` should pass AND the checklist should pass.
- Stage B: `validate` should pass AND the checklist should pass.
- Stage C: `apply` should complete AND the checklist should pass.
